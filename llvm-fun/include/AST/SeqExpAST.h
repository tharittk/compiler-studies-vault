#ifndef FUN_AST_SEQEXPAST_H
#define FUN_AST_SEQEXPAST_H
...
public:
  SeqExpAST(SrcLoc srcLoc, ExpAST *exp1, ExpAST *exp2);
  ~SeqExpAST();
  ...
  static bool classof(const BaseAST *n) { return n->getOp() == OP_Seq; }
